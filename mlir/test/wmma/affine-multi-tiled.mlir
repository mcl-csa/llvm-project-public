...
module  {
  ...
  func @main() {
    ...
    %00 = memref.cast %0 : memref<1024x1024xf16> to memref<*xf16>
    gpu.host_register %00 : memref<*xf16>
    %11 = memref.cast %1 : memref<1024x1024xf16> to memref<*xf16>
    gpu.host_register %11 : memref<*xf16>
    %22 = memref.cast %2 : memref<1024x1024xf16> to memref<*xf16>
    gpu.host_register %22 : memref<*xf16>

    affine.for %arg0 = 0 to 1024 step 64 {
      affine.for %arg1 = 0 to 1024 step 64 {
        %3 = memref.get_global @asmem : memref<64x64xf16, 3>
        %4 = memref.get_global @bsmem : memref<64x64xf16, 3>
